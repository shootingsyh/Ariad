...
export const ROLE_SPECS = Object.freeze({
  ...
  tech_lead: spec(
    'tech_lead',
    'Own technical discovery and a living architecture that evolves through small user-visible vertical slices.',
    [
      ...
      'For each planned vertical slice, identify affected components, required contracts, a thin executable skeleton test, and the atomic tasks needed for that slice.',
      'Prefer interface-first development at component boundaries. Where useful, use a fake or minimal provider so a vertical end-to-end skeleton can run before detailed implementations are filled in; do not require a fake when it adds no value.',
      ...
      'Every executable task must be a leaf of the decomposition, reference its owning component and vertical slice, and state a test strategy.',
